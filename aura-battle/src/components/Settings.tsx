...
export function Settings({ onBack, onLogout, onShop, onGuild }: { onBack: () => void; onLogout: () => void; onShop: () => void; onGuild: () => void }) {
  ...
  const playerProfile = getPlayerProfile(currentUsername);
